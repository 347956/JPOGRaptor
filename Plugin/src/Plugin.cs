...
namespace JPOGRaptor {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var bundleName = "jpograptorassets";
            ...
            var JPOGRaptor = ModAssets.LoadAsset<EnemyType>("JPOGRaptor");
            var JPOGRaptorTN = ModAssets.LoadAsset<TerminalNode>("JPOGRaptorTN");
            var JPOGRaptorTK = ModAssets.LoadAsset<TerminalKeyword>("JPOGRaptorTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var JPOGRaptorLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var JPOGRaptorCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(JPOGRaptor.enemyPrefab);
            ...
            Enemies.RegisterEnemy(JPOGRaptor, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, JPOGRaptorTN, JPOGRaptorTK);
            // For using our rarity tables, we can use the following:
            // Enemies.RegisterEnemy(JPOGRaptor, JPOGRaptorLevelRarities, JPOGRaptorCustomLevelRarities, JPOGRaptorTN, JPOGRaptorTK);
